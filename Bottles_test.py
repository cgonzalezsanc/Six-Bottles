...
"""
		self.assertEqual(expected, Bottles().verse(89))
...
"""
		self.assertEqual(expected, Bottles().verse(2))
...
Take one down and pass it around, no more six-pack of beer on the wall.
...
Take one down and pass it around, no more six-pack of beer on the wall.
"""
		self.assertEqual(expected, Bottles().verse(6))

	def test_verse_milk(self):
		expected = """7 bottles of milk on the wall, 7 bottles of milk.
Take one down and pass it around, 6 bottles of milk on the wall.
"""
		self.assertEqual(expected, Bottles().verse(7,'milk'))

	def test_verses_milk(self):
...
"""
		self.assertEqual(expected, Bottles().verses(99, 98, 'milk'))

	def test_another_beverage(self):
		expected = """99 bottles of milk on the wall, 99 bottles of milk.
Take one down and pass it around, 98 bottles of milk on the wall.
...
Take one down and pass it around, no more six-pack of milk on the wall.
...
""" 
		self.assertEqual(expected, Bottles().song('milk'))
